      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <a href="{{ route('services.index') }}" class="btn btn-primary" style="margin-left: 10px;color:white">All Services</a>
          </div>
<form method="POST" action="{{route('services.update','test')}}" enctype="multipart/form-data">
    @csrf
    @method('patch')
    <div class="form-group" style="margin-left: 10px;">
      <label for="exampleInputEmail1">Word</label>
      <input type="text" class="form-control" name="word" value="{{$services->word }}">
    </div>
    ...
    <div class="form-group" style="margin-left: 10px;">
      ...
      <div class="form-group" style="margin-left: 10px;">
        ...
        <input type="text" class="form-control" name="color" value="{{$services->color }}">
      </div>
