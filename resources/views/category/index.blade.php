      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <a href="{{ route('categories.create') }}" class="btn btn-primary" style="margin-left: 10px;color:white">Add Category</h6></a>
          </div>
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <h6 class="mb-0 text-sm">{{ $category->word }}</h6>
                    </td>
                    <td>
                        <h6 class="mb-0 text-sm">{{ $category->desc }}</h6>
                    </td>
                    <td>
                        <i class="{{$category->icon }}"></i>
                    </td>
                    <td class="align-middle">
                        <a href="{{ route('categories.edit',$category->id) }}" class="btn btn-success" data-toggle="tooltip">
                            Edit
                          </a>
                      <a href="{{ route('categories.destroy',$category->id) }}" class="btn btn-danger" data-toggle="tooltip">
                        Delete
                      </a>
                    </td>
                  </tr>
