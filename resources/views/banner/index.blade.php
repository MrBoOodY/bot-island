      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <a href="{{ route('banners.create') }}"class="btn btn-primary" style="margin-left: 10px;color:white">Add Banner</h6></a>
          </div>
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <img src="/bannerFolder/{{$banner->image}}" style="width:700px; height:200px;">
                    </td>
                    <td class="align-middle">
                      <a href="{{ route('banners.destroy',$banner->id) }}" class="btn btn-danger" data-toggle="tooltip">
                        Delete
                      </a>
                    </td>
                  </tr>
