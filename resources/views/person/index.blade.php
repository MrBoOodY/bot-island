      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0">
            <a href="{{ route('person.create') }}" class="btn btn-primary" style="margin-left: 10px;color:white">Add Person</h6></a>
          </div>
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <img src="/personFolder/{{$person->photo}}"style="width:700px; height:200px;">
                    </td>
                    <td>
                        <h6 class="mb-0 text-sm">{{$person->word }}</h6>
                      </td>
                      <td>
                    ...
                    <td class="align-middle">
                      ...
                      <a href="{{ route('person.destroy',$person->id) }}" class="btn btn-danger" data-toggle="tooltip">
                        Delete
                      </a>
                    </td>
                  </tr>
