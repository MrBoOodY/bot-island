                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-6">
                        <div class="footer-info">
                            <h3>BOTISLAND</h3>
                            <p class="pb-3"><em>We are an integral part of the modern technology and business landscape.</em>
                            </p>
                            <p>
                                Alf Maskan, Ain Shams <br>
                                Cairo, Egypt<br><br>
                                <strong>Phone:</strong> +201013223497<br>
                                <strong>Email:</strong> abdallamohamed197@gmail.com<br>
                            </p>
